                        ...
                        <div class="card-body">
                            <form action="" method="post">
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        <select name="paket" id="paket" class="form-control <?= form_error('paket') ? "is-invalid" : "" ?>">
                                            ...
                                            <?php foreach ($paket as $p) { ?>
                                                <option value="<?= $p->id ?>" <?= $p->id == $detail_paket->paket_id ? "selected" : "" ?>><?= $p->name ?></option>
                                            <?php } ?>
                                        </select>
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        <input type="text" class="form-control <?= form_error('title') ? "is-invalid" : "" ?>" name="title" id="title" value="<?= $detail_paket->title ?>">
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        <input type="text" class="form-control <?= form_error('sub_title') ? "is-invalid" : "" ?>" name="sub_title" id="sub_title" value="<?= $detail_paket->sub_title ?>">
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        <input type="number" class="form-control <?= form_error('price') ? "is-invalid" : "" ?>" name="price" id="price" value="<?= $detail_paket->price ?>">
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        <textarea class="form-control" name="detail_desc" id="desc"><?= $detail_paket->detail_desc ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
