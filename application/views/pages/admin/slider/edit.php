    ...
    <section class="section">
        <div class="section-header">
            <div class="section-header-back">
                <a href="<?= base_url('admin/slider') ?>" class="btn btn-icon"><i class="fas fa-arrow-left"></i></a>
            </div>
            <h1><?= $title ?></h1>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12 col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="<?= base_url('admin/slider/edit/' . $slider->id) ?>" method="post" enctype="multipart/form-data" autocomplete="off">
                                <div class="form-group row mb-4">
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Judul *</label>
                                    <div class="col-sm-12 col-md-6">
                                        <input type="text" class="form-control <?= form_error('title') ? "is-invalid" : "" ?>" name="title" value="<?= $slider->title ?>" autofocus>
